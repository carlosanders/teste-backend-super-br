...
class VinculacaoAviso extends RestDto
{
     ...
     * )
     *
     * @OA\Property(ref=@Model(type=AvisoDTO::class))
    ...
    public function setModalidadeOrgaoCentral(?EntityInterface $modalidadeOrgaoCentral): VinculacaoAviso
    {
    ...
    public function setUnidade(?EntityInterface $unidade): VinculacaoAviso
    {
