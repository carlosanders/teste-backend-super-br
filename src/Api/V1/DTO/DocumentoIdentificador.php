...
class DocumentoIdentificador extends RestDto
{
     ...
     * )
     *
     * @OA\Property(ref=@Model(type=ModalidadeDocumentoIdentificadorDTO::class))
    ...
    /**
     * @return EntityInterface|ModalidadeDocumentoIdentificadorDTO|ModalidadeDocumentoIdentificadorEntity|null
     */
    ...
    /**
     * @param EntityInterface|ModalidadeDocumentoIdentificadorDTO|ModalidadeDocumentoIdentificadorEntity|null $modalidadeDocumentoIdentificador
     */
    public function setModalidadeDocumentoIdentificador(
        ?EntityInterface $modalidadeDocumentoIdentificador
    ): self {
