...
class Setor extends RestDto
{
     ...
     * )
     *
     * @OA\Property(ref=@Model(type=GeneroSetorDTO::class))
    ...
    /**
     * @return EntityInterface|GeneroSetorDTO|GeneroSetorEntity|null
     */
    ...
    /**
     * @param EntityInterface|GeneroSetorDTO|GeneroSetorEntity|null $generoSetor
     */
    ...
    /**
     * @param EntityInterface|SetorDTO|SetorEntity|null $parent
     */
    ...
    /**
     * @param EntityInterface|SetorDTO|SetorEntity|null $unidadePai
     */
