...
class Notificacao extends RestDto
{
     ...
     * )
     *
     * @OA\Property(ref=@Model(type=ModalidadeNotificacaoDTO::class))
     ...
     * )
     *
     * @OA\Property(ref=@Model(type=TipoNotificacaoDTO::class))
    ...
    /**
     * @return EntityInterface|ModalidadeNotificacaoDTO|ModalidadeNotificacaoEntity|null
     */
    ...
    /**
     * @param EntityInterface|ModalidadeNotificacaoDTO|ModalidadeNotificacaoEntity|null $modalidadeNotificacao
     */
    ...
    public function setContexto(?string $contexto): Notificacao
    {
     ...
     */
    public function setTipoNotificacao(?EntityInterface $tipoNotificacao): Notificacao
    {
