 ...
 *     fieldMapping = {"usuario": "usuario","role": "role"},
...
class VinculacaoRole extends RestDto
{
     ...
     * )
     *
     * @OA\Property(ref=@Model(type=ApiKeyDTO::class))
    ...
    /**
     * @return EntityInterface|ApiKeyDTO|ApiKeyEntity|null|null
     */
    ...
    /**
     * @param EntityInterface|ApiKeyDTO|ApiKeyEntity|null $apiKey
     */
    public function setApiKey(
        ?EntityInterface $apiKey
    ): self {
