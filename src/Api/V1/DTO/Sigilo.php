...
class Sigilo extends RestDto
{
     ...
     * )
     *
     * @OA\Property(ref=@Model(type=ModalidadeCategoriaSigiloDTO::class))
     ...
     * )
     *
     * @OA\Property(ref=@Model(type=TipoSigiloDTO::class))
    ...
    /**
     * @return EntityInterface|ModalidadeCategoriaSigiloDTO|ModalidadeCategoriaSigiloEntity|null
     */
    ...
    /**
     * @param EntityInterface|ModalidadeCategoriaSigiloDTO|ModalidadeCategoriaSigiloEntity|null $modalidadeCategoriaSigilo
     */
    ...
    /**
     * @return EntityInterface|TipoSigiloDTO|TipoSigiloEntity|null
     */
    ...
    /**
     * @param EntityInterface|TipoSigiloDTO|TipoSigiloEntity|null $tipoSigilo
     */
