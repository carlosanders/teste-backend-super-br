 ...
 *      entityClass="SuppCore\AdministrativoBackend\Entity\Navio",
 *      message = "Campo já está em utilização!"
 * )
 *
 * @DTOMapper\JsonLD(
 *     jsonLDId="/v1/administrativo/navio/{id}",
 *     jsonLDType="Navio",
 *     jsonLDContext="/api/doc/#model-Navio"
 * )
 *
 * @Form\Form()
 * @Form\Cacheable(expire="86400")
 */
class Navio extends RestDto
{
    use IdUuid;
    use Valor;
    use Descricao;
