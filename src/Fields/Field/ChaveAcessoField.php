...
class ChaveAcessoField implements FieldInterface
{
    ...
    public function render(string $transactionId, $context = [], $options = []): ?string
    {
        ...
        return "<hr>Atenção, a consulta ao processo eletrônico está disponível em $url mediante o fornecimento do Número Único de Protocolo (NUP) $nup e da chave de acesso $chaveAcesso";
    }
}
