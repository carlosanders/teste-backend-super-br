...
use SuppCore\AdministrativoBackend\Mapper\Driver\AnnotationsDriver as MapperAnnotationsDriver;
use SuppCore\AdministrativoBackend\Form\Driver\AnnotationsDriver as FormAnnotationsDriver;
...
class CacheWarmer implements CacheWarmerInterface
{
    ...
    public function __construct(
        private MapperAnnotationsDriver $mapperAnnotationsDriver,
        private FormAnnotationsDriver $formAnnotationsDriver,
        array $includePaths,
        array $excludePaths = []
    ) {
    ...
    public function warmUp($cacheDir)
    {
        ...
        foreach ($finder as $file) {
            ...
            foreach ($classes as $class) {
                $this->mapperAnnotationsDriver->getMetadata($class);
                $this->formAnnotationsDriver->getMetadata($class);
            }
        }
