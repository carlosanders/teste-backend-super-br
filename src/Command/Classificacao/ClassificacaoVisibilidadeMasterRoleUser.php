...
class ClassificacaoVisibilidadeMasterRoleUser extends Command
{
    ...
    public function __construct(private LoggerInterface $logger,
        ...
        parent::__construct('supp:classificacao:visibilidade:maste:role_user');
        $this->setDescription('Command para adição da ROLE_USER como MASTER para todas as classificações');
    }
