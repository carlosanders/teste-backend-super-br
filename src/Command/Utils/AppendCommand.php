...
class AppendCommand extends Command
{
    ...
    {
        parent::__construct('supp:append');
        ...
        $this->setDescription('Console command to list API keys')
            ->addOption('altDirs', 'd', InputOption::VALUE_REQUIRED, 'Lista opcional de diretórios com arquivos YML que serão carregados, separados por vírgula')
