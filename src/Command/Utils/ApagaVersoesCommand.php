...
class ApagaVersoesCommand extends Command
{
    ...
    public function __construct(
        ...
        parent::__construct('supp:componentesdigitais:apagaversoes');
        ...
        $this
            ->setDescription('Apaga versoes antigas dos componentes digitais juntados ha 6 meses')
            ->addOption('batch', null, InputOption::VALUE_OPTIONAL, 'Qual o tamanho do batch (default 100)?');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln($this->processa($batch, $output));
    }
     ...
     * @return bool
     */
    private function processa($batch, OutputInterface $output)
    {
        try {
