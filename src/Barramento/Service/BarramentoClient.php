...
class BarramentoClient extends BarramentoSoap
{
    ...
    public function consultarRepositoriosDeEstruturas(bool $ativo = true): mixed
    {
        ...
        try {
            ...
            $consultarRespositoriosResponse = $this->client->consultarRepositoriosDeEstruturas($params);
        } catch (SoapFault $e) {
    ...
    public function consultarEstruturas(
        ...
        try {
            ...
            $consultarEstruturasResponse = $this->client->consultarEstruturas($params);
        } catch (SoapFault $e) {
            $this->processaErroBarramento($e);
    ...
    public function consultarEstruturasPorEstruturaPai(
        ...
        try {
            ...
            $consultarEstruturasPorEstruturaPaiResponse = $this->client->consultarEstruturasPorEstruturaPai($params);
        } catch (SoapFault $e) {
            $this->processaErroBarramento($e);
    ...
    public function listarPendencias(): mixed
    {
        ...
        try {
            ...
            $listarPendenciasResponse = $this->client->listarPendencias($params);
        } catch (SoapFault $e) {
            $this->processaErroBarramento($e);
    ...
    public function consultarTramites(int $idt = null, string $protocolo = null, int $situacao = null): mixed
    {
        ...
        try {
            ...
            $consultarTramitesResponse = $this->client->consultarTramites($params);
        } catch (SoapFault $e) {
            $this->processaErroBarramento($e);
    ...
    public function enviarProcesso(stdClass $params): mixed
    {
        try {
            ...
            $enviarProcessoResponse = $this->client->enviarProcesso($params);
        } catch (SoapFault $e) {
            $this->processaErroBarramento($e);
    ...
    public function enviarDocumento(stdClass $params): mixed
    {
        try {
            ...
            $enviarDocumentoResponse = $this->client->enviarDocumento($params);
        } catch (SoapFault $e) {
            $this->processaErroBarramento($e);
    ...
    public function enviarComponenteDigital(stdClass $params): mixed
    {
        try {
            ...
            $enviarComponenteDigitalResponse = $this->client->enviarComponenteDigital($params);
        } catch (SoapFault $e) {
            $this->processaErroBarramento($e);
    ...
    public function receberReciboDeTramite(int $idt): mixed
    {
        ...
        try {
            ...
            $receberReciboDeTramiteResponse = $this->client->receberReciboDeTramite($params);
        } catch (SoapFault $e) {
            $this->processaErroBarramento($e);
            throw $e;
        }
    ...
    public function cancelarEnvioDeTramite(int $idt): mixed
    {
        ...
        try {
            ...
            $cancelarEnvioDeTramiteResponse = $this->client->cancelarEnvioDeTramite($params);
        } catch (SoapFault $e) {
            $this->processaErroBarramento($e);
    ...
    public function reproduzirUltimoTramite(
        ...
        try {
            ...
            $reproduzirUltimoTramiteResponse = $this->client->reproduzirUltimoTramite($params);
        } catch (SoapFault $e) {
            $this->processaErroBarramento($e);
    ...
    public function solicitarMetadados(stdClass $params): mixed
    {
        try {
            ...
            $solicitarMetadadosResponse = $this->client->solicitarMetadados($params);
        } catch (SoapFault $e) {
            $this->processaErroBarramento($e);
    ...
    public function receberComponenteDigital(stdClass $params): mixed
    {
        try {
            ...
            $receberComponenteDigitalResponse = $this->client->receberComponenteDigital($params);
        } catch (SoapFault $e) {
            $this->processaErroBarramento($e);
    ...
    public function enviarReciboDeTramite(stdClass $params): mixed
    {
        try {
            ...
            $receberComponenteDigitalResponse = $this->client->enviarReciboDeTramite($params);
        } catch (SoapFault $e) {
            $this->processaErroBarramento($e);
    ...
    public function recusarTramite(int $idt, int $codMotivoRecusa = 99, ?string $justificativa = null): mixed
    {
        ...
        try {
            ...
            $receberComponenteDigitalResponse = $this->client->recusarTramite($params);
        } catch (SoapFault $e) {
            $this->processaErroBarramento($e);
    ...
    public function cienciaRecusa(int $idt): mixed
    {
        ...
        try {
            ...
            $receberComponenteDigitalResponse = $this->client->cienciaRecusa($params);
        } catch (SoapFault $e) {
            $this->processaErroBarramento($e);
            throw $e;
        }
