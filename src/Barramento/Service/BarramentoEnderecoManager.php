...
class BarramentoEnderecoManager
{
    ...
    /**
     * BarramentoEnderecoManager constructor.
    ...
    public function sincronizaEndereco($interessadoTramitacao, Pessoa $pessoa, string $transactionId): Pessoa
    {
        ...
        if (isset($interessadoTramitacao->endereco)) {
            ...
            $pessoa = $this->acrescentaEndereco($interessadoTramitacao, $enderecosSupp, $pessoa);
     ...
     * @throws OptimisticLockException
     */
    private function acrescentaEndereco($interessadoTramitacao, $enderecosSupp, Pessoa $pessoa): Pessoa
    {
        foreach ($interessadoTramitacao->endereco as $enderecoTramitacao) {
            ...
            if (false == $existe) {
                ...
                //Validar com área de Negócios
                $enderecoNovoDTO->setOrigemDados($this->origemDadosFactory());
