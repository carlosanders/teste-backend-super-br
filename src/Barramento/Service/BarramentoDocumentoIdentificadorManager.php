...
class BarramentoDocumentoIdentificadorManager
{
     ...
     */
    public function sincronizaDocumentoIdentificador($interessadoTramitacao, Pessoa $pessoa, $transactionId): mixed
    {
        ...
        if (isset($interessadoTramitacao->documentoDeIdentificacao)) {
            ...
            $pessoa = $this->acrescentaDocumentos($interessadoTramitacao, $documentosSupp, $pessoa);
     ...
     * @throws OptimisticLockException
     */
    private function acrescentaDocumentos($interessadoTramitacao, $documentosSupp, Pessoa $pessoa): Pessoa
    {
