 ...
 *
 * @Enableable()
 * @Immutable(fieldName="valor", expression=Immutable::EXPRESSION_IN, expressionValues="env:constantes.entidades.modalidade_transicao.immutable")
 *
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */
class Navio implements EntityInterface
{
    // Traits
    use Blameable;
    use Timestampable;
