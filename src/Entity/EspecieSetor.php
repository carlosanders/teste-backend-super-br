 ...
 *
 * @UniqueEntity(
 *     fields = {"nome", "generoSetor"},
 *     message = "Nome já está em utilização para esse gênero!"
 * )
 *
 * @Enableable()
 * @Immutable(fieldName="nome", expression=Immutable::EXPRESSION_IN, expressionValues="env:constantes.entidades.especie_setor.immutable")
 *
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */
