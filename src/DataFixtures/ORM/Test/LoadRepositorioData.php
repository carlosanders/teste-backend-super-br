...
class LoadRepositorioData extends Fixture implements OrderedFixtureInterface, FixtureGroupInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $repositorio1->setDocumento($this->getReference('Documento-MODELO DESPACHO DE APROVAÇÃO'));
        $repositorio1->setModalidadeRepositorio($this->getReference('ModalidadeRepositorio-JURISPRUDÊNCIA'));
        ...
        $repositorio2->setDocumento($this->getReference('Documento-TEMPLATE OFÍCIO'));
        $repositorio2->setModalidadeRepositorio($this->getReference('ModalidadeRepositorio-JURISPRUDÊNCIA'));
