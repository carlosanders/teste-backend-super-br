 ...
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */
class LoadStatusBarramentoData extends Fixture implements OrderedFixtureInterface, ContainerAwareInterface, FixtureGroupInterface
{
    ...
    public function load(\Doctrine\Persistence\ObjectManager $manager): void
    {
        ...
        $statusBarramento->setProcesso($this->getReference('Processo-TESTE_1'));
        $statusBarramento->setTramitacao(null);

        $this->manager->persist($statusBarramento);
