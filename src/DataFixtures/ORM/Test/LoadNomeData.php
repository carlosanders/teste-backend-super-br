 ...
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */
class LoadNomeData extends Fixture implements OrderedFixtureInterface, ContainerAwareInterface, FixtureGroupInterface
{
    ...
    public function load(\Doctrine\Persistence\ObjectManager $manager): void
    {
        ...
        $nome->setPessoa($this->getReference('Pessoa-12312312355'));
        $nome->setOrigemDados(null);

        $this->manager->persist($nome);
