 ...
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */
class LoadRegraEtiquetaData extends Fixture implements OrderedFixtureInterface, ContainerAwareInterface, FixtureGroupInterface
{
    ...
    public function load(\Doctrine\Persistence\ObjectManager $manager): void
    {
        ...
        $regraEtiqueta->setEtiqueta($this->getReference('Etiqueta-TESTE'));

        $this->manager->persist($regraEtiqueta);
