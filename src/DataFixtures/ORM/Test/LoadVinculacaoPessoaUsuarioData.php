...
class LoadVinculacaoPessoaUsuarioData extends Fixture implements OrderedFixtureInterface, ContainerAwareInterface, FixtureGroupInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $vinculacaoPessoaUsuario->setUsuarioVinculado($this->getReference('Usuario-00000000002'));
        $vinculacaoPessoaUsuario->setPessoa($this->getReference('Pessoa-12312312387'));
