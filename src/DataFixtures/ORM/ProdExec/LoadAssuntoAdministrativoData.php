...
class LoadAssuntoAdministrativoData extends Fixture implements OrderedFixtureInterface, ContainerAwareInterface, FixtureGroupInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-ADMINISTRAÇÃO'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-AGROPECUÁRIA, PESCA E EXTRATIVISMO'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-COMÉRCIO E SERVIÇOS'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-COMUNICAÇÕES'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-CULTURA'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-DEFESA NACIONAL'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-ECONOMIA E FINANÇAS'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-EDUCAÇÃO'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-ENERGIA'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-ESPORTE E LAZER'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-HABITAÇÃO'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-INDÚSTRIA'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-MEIO AMBIENTE'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-PESQUISA E DESENVOLVIMENTO'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-PREVIDÊNCIA SOCIAL'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-PROTEÇÃO SOCIAL'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-RELAÇÕES INTERNACIONAIS'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-SANEAMENTO'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-SAÚDE'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-SEGURANÇA E ORDEM PÚBLICA'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-TRABALHO'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-TRANSPORTES'));
        ...
        $assuntoAdministrativo->setParent($this->getReference('AssuntoAdministrativo-URBANISMO'));
