 ...
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */
class LoadTipoRelatorioAdministrativoData extends Fixture implements OrderedFixtureInterface, ContainerAwareInterface, FixtureGroupInterface
{
        ...
        public function load(ObjectManager $manager): void
        {
                ...
                $tipoRelatorio->setEspecieRelatorio($this->getReference('EspecieRelatorio-FLUXO DE TRABALHO'));
                ...
                $tipoRelatorio = new TipoRelatorio();
                $tipoRelatorio->setEspecieRelatorio($this->getReference('EspecieRelatorio-ATIVIDADES'));
                ...
                $tipoRelatorio = new TipoRelatorio();
                $tipoRelatorio->setEspecieRelatorio($this->getReference('EspecieRelatorio-COMUNICAÇÕES'));
                ...
                $tipoRelatorio = new TipoRelatorio();
                $tipoRelatorio->setEspecieRelatorio($this->getReference('EspecieRelatorio-RECURSOS HUMANOS'));
                ...
                $tipoRelatorio = new TipoRelatorio();
                $tipoRelatorio->setEspecieRelatorio($this->getReference('EspecieRelatorio-PROCESSOS/DOCUMENTOS AVULSOS'));
...
WHERE ac.apagadoEm IS NULL AND ac.usuario = :usuario');
                ...
                $tipoRelatorio = new TipoRelatorio();
                $tipoRelatorio->setEspecieRelatorio($this->getReference('EspecieRelatorio-USUÁRIOS'));
                ...
                $tipoRelatorio = new TipoRelatorio();
                $tipoRelatorio->setEspecieRelatorio($this->getReference('EspecieRelatorio-TABELAS'));
...
ORDER BY m.valor ASC, u.nome ASC');
                ...
                $tipoRelatorio->setTemplateHTML('Resources/Relatorio/lista.html.twig');
                $tipoRelatorio->setParametros('unidade');
                $tipoRelatorio->setDQL('SELECT u.nome, u.email, ca.nome as cargo, s.nome as setor, l.coordenador, l.distribuidor FROM SuppCore\AdministrativoBackend\Entity\Lotacao l INNER JOIN l.colaborador c LEFT JOIN c.cargo ca INNER JOIN c.usuario u INNER JOIN l.setor s INNER JOIN s.unidade un WHERE u.enabled = 1 AND un.id = :unidade ORDER BY s.nome, u.nome');
                $this->manager->persist($tipoRelatorio);
                $this->addReference('TipoRelatorio-' . $tipoRelatorio->getNome(), $tipoRelatorio);

                $tipoRelatorio = new TipoRelatorio();
                $tipoRelatorio->setEspecieRelatorio($this->getReference('EspecieRelatorio-TAREFAS'));
...
WHERE t.dataHoraConclusaoPrazo >= :dataHoraInicio AND t.dataHoraConclusaoPrazo <= :dataHoraFim AND u.id = :unidade');
                ...
                $tipoRelatorio = new TipoRelatorio();
                $tipoRelatorio->setEspecieRelatorio($this->getReference('EspecieRelatorio-TRAMITAÇÕES'));
         ...
         */
                ...
                $tipoRelatorio = new TipoRelatorio();
                $tipoRelatorio->setEspecieRelatorio($this->getReference('EspecieRelatorio-PLANO DE CLASSIFICAÇÃO'));
              ...
              $tipoRelatorio = new TipoRelatorio();
              $tipoRelatorio->setEspecieRelatorio($this->getReference('EspecieRelatorio-TABELA DE TEMPORALIDADE'));
            ...
            $tipoRelatorio = new TipoRelatorio();
            $tipoRelatorio->setEspecieRelatorio($this->getReference('EspecieRelatorio-FLUXO DE TRAMITAÇÕES'));
            ...
            $tipoRelatorio = new TipoRelatorio();
            $tipoRelatorio->setEspecieRelatorio($this->getReference('EspecieRelatorio-FLUXO DE TAREFAS'));
            ...
            $tipoRelatorio = new TipoRelatorio();
            $tipoRelatorio->setEspecieRelatorio($this->getReference('EspecieRelatorio-HISTÓRICO'));
