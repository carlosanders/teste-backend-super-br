 ...
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */
class LoadEstadoData extends Fixture implements OrderedFixtureInterface, ContainerAwareInterface, FixtureGroupInterface
{
    ...
    public function load(\Doctrine\Persistence\ObjectManager $manager): void
    {
        ...
        $estado->setNome('ACRE');
        $estado->setUf('AC');
        $estado->setPais($this->getReference('Pais-BR'));
