 ...
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */
class LoadEspecieAtividadeData extends Fixture implements OrderedFixtureInterface, ContainerAwareInterface, FixtureGroupInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $especieAtividade->setGeneroAtividade($this->getReference('GeneroAtividade-ADMINISTRATIVO'));

        $this->manager->persist($especieAtividade);
        ...
        $especieAtividade->setGeneroAtividade($this->getReference('GeneroAtividade-ARQUIVÍSTICO'));
