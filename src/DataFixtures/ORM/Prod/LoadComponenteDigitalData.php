...
class LoadComponenteDigitalData extends Fixture implements OrderedFixtureInterface, ContainerAwareInterface, FixtureGroupInterface
{
    ...
    public function load(\Doctrine\Persistence\ObjectManager $manager): void
    {
        ...
        $componenteDigital->setDocumento($this->getReference('Documento-TEMPLATE DESPACHO'));
        ...
        $componenteDigital->setEditavel(true);
        $componenteDigital->setMimetype('text/html');
        $componenteDigital->setDocumento($this->getReference('Documento-MODELO DESPACHO EM BRANCO'));
        ...
        $componenteDigital->setEditavel(true);
        $componenteDigital->setMimetype('text/html');
        $componenteDigital->setDocumento($this->getReference('Documento-TEMPLATE OFÍCIO'));
        ...
        $componenteDigital->setEditavel(true);
        $componenteDigital->setMimetype('text/html');
        $componenteDigital->setDocumento($this->getReference('Documento-MODELO OFÍCIO EM BRANCO'));
