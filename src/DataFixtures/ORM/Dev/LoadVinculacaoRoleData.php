...
class LoadVinculacaoRoleData extends Fixture implements OrderedFixtureInterface, ContainerAwareInterface, FixtureGroupInterface
{
    ...
    public function load(\Doctrine\Persistence\ObjectManager $manager): void
    {
        ...
        $entity = new VinculacaoRole();
        $entity->setRole('ROLE_ADMIN');
        $entity->setUsuario($this->getReference('Usuario-10000000004'));
        ...
        $entity = new VinculacaoRole();
        $entity->setRole('ROLE_ADMIN');
        $entity->setUsuario($this->getReference('Usuario-20000000004'));
        ...
        $entity = new VinculacaoRole();
        $entity->setRole('ROLE_ADMIN');
        $entity->setUsuario($this->getReference('Usuario-30000000004'));
        ...
        $entity = new VinculacaoRole();
        $entity->setRole('ROLE_ADMIN');
        $entity->setUsuario($this->getReference('Usuario-40000000004'));
