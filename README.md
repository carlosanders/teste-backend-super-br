# para a utilização das ferramentas de analise estática do código é preciso ter o php8.1 e php8.1-xml instalados na maquina local onde a IDE está rodando
